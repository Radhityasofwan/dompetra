...
<div class="modal-backdrop" id="modalTx" onclick="if(event.target === this) Dompetra.utils.closeAll()">
    <div class="sheet">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
            ...
            <div id="tx-cat-badge" style="background:var(--fin-primary-soft); color:var(--fin-primary); padding:6px 16px; border-radius:14px; font-size:13px; font-weight:800;">Umum</div>
        </div>
        ...
        <div class="sheet-scroll">
            <div class="numpad-display" style="text-align:center; margin-bottom:32px;">
                <div class="numpad-val" id="num-display" style="font-size: 56px; font-weight: 800; color: var(--fin-primary); letter-spacing: -2px;">0</div>
            </div>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-4"><button class="num-btn w-100 text-danger" style="color:var(--fin-danger);" onclick="Dompetra.pad.clear()">C</button></div>
                <div class="col-4"><button class="num-btn w-100" onclick="Dompetra.pad.tap('0')">0</button></div>
                <div class="col-4"><button class="num-btn w-100" onclick="Dompetra.pad.back()"><i class="ph-bold ph-backspace"></i></button></div>
            </div>
            ...
            <div id="tx-wallet-wrapper" style="margin-bottom:24px;">
                <label style="font-size:13px; font-weight:800; color:var(--fin-text-muted); text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; display:block;">Sumber Dana</label>
            ...
            <div id="tx-budget-alloc-container" style="display:none; margin-bottom:24px;">
                 <label style="font-size:13px; font-weight:800; color:var(--fin-text-muted); text-transform:uppercase; letter-spacing:1px; margin-bottom:12px; display:block;">Alokasi Budget</label>
                 <select id="tx-budget-id" class="inp-std w-100"><option value="">Tanpa Anggaran</option></select>
            </div>
            ...
            <div id="budget-date-container" style="display:none; gap:16px; margin-bottom:20px;">
                ...
                <div style="flex:1;">
                    <label style="font-size:12px; font-weight:700; margin-bottom:8px; display:block;">Durasi (Hari)</label>
                    <input type="number" id="budget-duration" class="inp-std w-100" value="30" onkeyup="Dompetra.utils.calcEndDate()">
                </div>
            </div>
            <div id="budget-end-disp" style="display:none; font-size:14px; color:var(--fin-text-muted); margin-bottom:28px;">
                Berakhir pada: <span id="budget-end-date" style="font-weight:800; color:var(--fin-text-dark);">...</span>
            </div>

            <div class="row g-3 mt-2">
                <div class="col-4" id="btn-del-tx-col" style="display:none;">
                    <button class="num-btn w-100" style="color:var(--fin-danger); border-color:var(--fin-danger);" onclick="Dompetra.data.delMain()">Hapus</button>
                </div>
                <div class="col">
...
<div class="modal-backdrop" id="modalWallet" onclick="if(event.target === this) Dompetra.utils.closeAll()">
    <div class="sheet">
        ...
        <div class="sheet-scroll">
            ...
            <input type="text" id="w-name" class="inp-std w-100" placeholder="Contoh: BCA, Dompet Saku" style="margin-bottom:20px;">
            ...
            <label style="font-size:13px; font-weight:800; color:var(--fin-text-muted); text-transform:uppercase; letter-spacing:1px; margin-bottom:16px; text-align:center; display:block;">Warna Kartu</label>
            <input type="hidden" id="w-color" value="grad-blue">
            <div style="display:flex; gap:16px; margin-bottom:40px; justify-content: center;">
                <div class="w-color-opt grad-blue" onclick="Dompetra.utils.setWColor('grad-blue')" style="width:48px; height:48px; border-radius:50%; border:3px solid var(--fin-text-dark); cursor:pointer; transition:border-color 0.2s;"></div>
                <div class="w-color-opt grad-green" onclick="Dompetra.utils.setWColor('grad-green')" style="width:48px; height:48px; border-radius:50%; border:3px solid transparent; cursor:pointer; transition:border-color 0.2s;"></div>
                <div class="w-color-opt grad-purple" onclick="Dompetra.utils.setWColor('grad-purple')" style="width:48px; height:48px; border-radius:50%; border:3px solid transparent; cursor:pointer; transition:border-color 0.2s;"></div>
                <div class="w-color-opt grad-orange" onclick="Dompetra.utils.setWColor('grad-orange')" style="width:48px; height:48px; border-radius:50%; border:3px solid transparent; cursor:pointer; transition:border-color 0.2s;"></div>
                <div class="w-color-opt grad-dark" onclick="Dompetra.utils.setWColor('grad-dark')" style="width:48px; height:48px; border-radius:50%; border:3px solid transparent; cursor:pointer; transition:border-color 0.2s;"></div>
            </div>

            <div style="display:flex; gap:16px;">
                <button class="num-btn w-100" id="btn-del-wallet" style="flex:1; color:var(--fin-danger); border-color:var(--fin-danger); display:none;" onclick="Dompetra.data.delWallet()">Hapus</button>
                <button class="num-btn primary w-100" style="flex:2;" onclick="Dompetra.data.saveWallet()">Simpan</button>
            </div>
...
<div class="modal-backdrop" id="modalFilter" onclick="if(event.target === this) Dompetra.utils.closeAll()">
    <div class="sheet">
        ...
        <div class="sheet-scroll">
            <div class="list-card liquid-glass" onclick="Dompetra.utils.setFilterMode('payday')" id="opt-payday" style="margin-bottom:16px;">
                <div class="icon-box" style="background:var(--fin-primary-soft); color:var(--fin-primary);"><i class="ph-bold ph-calendar-check"></i></div>
                <div style="flex:1;"><div style="font-weight:800; font-size:15px;">Ikuti Periode Gaji</div><div style="font-size:13px; color:var(--fin-text-muted); margin-top:4px;">Otomatis reset tiap gajian</div></div>
            ...
            <div class="list-card liquid-glass" onclick="Dompetra.utils.setFilterMode('custom')" id="opt-custom">
                <div class="icon-box" style="background:var(--fin-bg-base); color:var(--fin-text-muted);"><i class="ph-bold ph-faders"></i></div>
                <div style="flex:1;"><div style="font-weight:800; font-size:15px;">Kustomisasi</div><div style="font-size:13px; color:var(--fin-text-muted); margin-top:4px;">Pilih tanggal sendiri</div></div>
            ...
            <div id="date-range-inputs" style="display:none; margin-top:24px; padding-top:24px; border-top:1px dashed var(--fin-border);">
                <div class="row g-3 mb-4">
                    <div class="col-6">
                        <label style="font-size:12px; font-weight:700; margin-bottom:8px; display:block;">Dari Tanggal</label>
                        <input type="date" id="filter-start" class="inp-std w-100">
                    </div>
                    <div class="col-6">
                        <label style="font-size:12px; font-weight:700; margin-bottom:8px; display:block;">Sampai Tanggal</label>
                        <input type="date" id="filter-end" class="inp-std w-100">
                    </div>
                </div>
                <button class="num-btn primary w-100" onclick="Dompetra.utils.applyFilter(); Dompetra.utils.closeAll();">Terapkan Filter</button>
            </div>
...
<div class="modal-backdrop" id="modalQA" onclick="if(event.target === this) Dompetra.utils.closeAll()">
    <div class="sheet">
        ...
        <div class="sheet-scroll">
            ...
            <input type="text" id="qa-label" class="inp-std w-100" placeholder="Misal: Makan Siang 20k" style="margin-bottom:20px;">
...
<div class="modal-backdrop" id="modalCat" onclick="if(event.target === this) Dompetra.utils.closeAll()">
    <div class="sheet">
        ...
        <div class="sheet-scroll">
            ...
            <input type="text" id="cat-name" class="inp-std w-100" placeholder="Nama Kategori" style="margin-bottom:20px;">
            ...
            <div style="display:flex; gap:16px;">
                <button class="num-btn w-100" id="btn-del-cat" style="flex:1; color:var(--fin-danger); border-color:var(--fin-danger);" onclick="Dompetra.data.delCat()">Hapus</button>
...
<div class="modal-backdrop" id="modalProfile" onclick="if(event.target === this) Dompetra.utils.closeAll()">
    <div class="sheet">
        ...
        <div class="sheet-scroll">
            ...
            <label style="font-size:13px; font-weight:700; margin-bottom:10px; display:block;">Tanggal Gajian (1-31)</label>
...
<div class="modal-backdrop" id="modalTheme" onclick="if(event.target === this) Dompetra.utils.closeAll()">
    <div class="sheet">
        ...
        <div class="sheet-scroll">
            ...
            <!-- NOTIFIKASI TOGGLE -->
            <div style="font-size:12px; font-weight:800; color:var(--fin-text-muted); margin-bottom:16px; text-transform:uppercase; letter-spacing:1px;">Push Notifikasi</div>
            <div class="list-card liquid-glass" onclick="Dompetra.pwa.enableNotifications()" style="margin-bottom:32px;">
                <div class="icon-box bg-gray"><i class="ph-bold ph-bell"></i></div>
                <div style="flex:1;"><div style="font-weight:800; font-size:15px;">Izinkan Notifikasi</div><div style="font-size:13px; color:var(--fin-text-muted); margin-top:4px;">Pengingat budget otomatis</div></div>
                <div class="check-circle" id="chk-notif" style="opacity:0; background:var(--fin-primary); color:white; border:none; transition:opacity 0.3s;"><i class="ph-bold ph-check"></i></div>
            </div>

            <!-- Pengaturan Tema Terang / Gelap -->
            <div style="font-size:12px; font-weight:800; color:var(--fin-text-muted); margin-bottom:16px; text-transform:uppercase; letter-spacing:1px;">Mode Layar</div>
            <div class="list-card liquid-glass" onclick="Dompetra.utils.setTheme('auto')" style="margin-bottom:12px;">
                ...
                <div style="flex:1;"><div style="font-weight:800; font-size:15px;">Otomatis (Sistem)</div></div>
            ...
            <div class="list-card liquid-glass" onclick="Dompetra.utils.setTheme('light')" style="margin-bottom:12px;">
                ...
                <div style="flex:1;"><div style="font-weight:800; font-size:15px;">Terang</div></div>
            ...
            <div class="list-card liquid-glass" onclick="Dompetra.utils.setTheme('dark')">
                ...
                <div style="flex:1;"><div style="font-weight:800; font-size:15px;">Gelap</div></div>
            ...
            <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-bottom:20px;">
                <div style="font-size:12px; font-weight:800; color:var(--fin-text-muted); text-transform:uppercase; letter-spacing:1px;">Warna Aksen Dominan</div>
                <div style="font-size:11px; font-weight:600; color:var(--fin-primary);">Geser <i class="ph-bold ph-arrow-right"></i></div>
            </div>
            
            <div class="color-swatch-container" style="padding-bottom: 24px;">
                <!-- 10 Preset Tema Populer -->
                <div class="color-swatch active" style="background:linear-gradient(135deg, #1D4ED8, #60A5FA);" onclick="Dompetra.utils.setColorTheme('sapphire')" id="csw-sapphire"></div>
                <div class="color-swatch" style="background:linear-gradient(135deg, #0F766E, #2DD4BF);" onclick="Dompetra.utils.setColorTheme('jade')" id="csw-jade"></div>
                <div class="color-swatch" style="background:linear-gradient(135deg, #B91C1C, #F87171);" onclick="Dompetra.utils.setColorTheme('crimson')" id="csw-crimson"></div>
                <div class="color-swatch" style="background:linear-gradient(135deg, #A21CAF, #F472B6);" onclick="Dompetra.utils.setColorTheme('magenta')" id="csw-magenta"></div>
                <div class="color-swatch" style="background:linear-gradient(135deg, #C2410C, #FBBF24);" onclick="Dompetra.utils.setColorTheme('tangerine')" id="csw-tangerine"></div>
                <div class="color-swatch" style="background:linear-gradient(135deg, #374151, #94A3B8);" onclick="Dompetra.utils.setColorTheme('graphite')" id="csw-graphite"></div>
                <div class="color-swatch" style="background:linear-gradient(135deg, #0891B2, #67E8F9);" onclick="Dompetra.utils.setColorTheme('cyan')" id="csw-cyan"></div>
                <div class="color-swatch" style="background:linear-gradient(135deg, #6D28D9, #A78BFA);" onclick="Dompetra.utils.setColorTheme('lavender')" id="csw-lavender"></div>
                <div class="color-swatch" style="background:linear-gradient(135deg, #9A3412, #FDBA74);" onclick="Dompetra.utils.setColorTheme('bronze')" id="csw-bronze"></div>
                <div class="color-swatch" style="background:linear-gradient(135deg, #4D7C0F, #A3E635);" onclick="Dompetra.utils.setColorTheme('olive')" id="csw-olive"></div>
                
                <!-- Custom RGB Color Picker -->
                <div class="color-swatch" style="background:conic-gradient(from 90deg, red, yellow, lime, aqua, blue, magenta, red); display:flex; align-items:center; justify-content:center; position:relative; overflow:hidden;" id="csw-custom">
                    <i class="ph-bold ph-palette" style="color:white; font-size: 24px; filter:drop-shadow(0 2px 4px rgba(0,0,0,0.6)); pointer-events:none;"></i>
                    <input type="color" id="custom-color-input" style="position:absolute; inset:-10px; width:200%; height:200%; opacity:0; cursor:pointer;" onchange="Dompetra.utils.setCustomColor(this.value)">
                </div>
            </div>
...
<div class="modal-backdrop" id="modalCreateGroup" onclick="if(event.target === this) Dompetra.utils.closeAll()">
    <div class="sheet">
        ...
        <div class="sheet-scroll">
            ...
            <input type="text" id="new-group-name" class="inp-std w-100" placeholder="Keluarga Cemara" style="margin-bottom:32px;">
...
<div class="modal-backdrop" id="modalJoinGroup" onclick="if(event.target === this) Dompetra.utils.closeAll()">
    <div class="sheet">
        ...
        <div class="sheet-scroll">
            ...
            <input type="text" id="join-group-code" class="inp-std w-100" placeholder="Contoh: AB1234" style="margin-bottom:32px;">
